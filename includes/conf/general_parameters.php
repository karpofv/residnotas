...
$empresa_name   = "HOSPITAL"; // Nombre de la empresa
$system_title   = "HOSIPTAL | CONTROL DE NOTAS"; //titulo del sistema ::: TEC
$foot_page      = ".:: Aplicaci&oacute;n Web ::: HOSPITAL - CONTROL DE NOTAS ::.";
$host_system    = "";
$auth_table     = 'usuarios'; // Nombre de la tabla que contendra los datos de los usuarios
$usuarios_sesion = 'the_name_session';
$redir          = 'http://localhost/residnotas/index.php';
$ruta_base      = '//localhost/residnotas/';
// Configuracion de Modulos Activos en en Sistema (0:Inactivo, 1:Activo)
$mod_moodle  = 0;
//Mod Chat
global $absolute_uri;
$absolute_uri   = 'http://localhost/residnotas/';
$mod_chat       = 1;
// Mensajes de error.
